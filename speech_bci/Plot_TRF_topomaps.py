...
- Adjusted plot_topomap function to be compatible with newer versions of MNE (Michał Madej & Dawid Jędrzejewski):
    - changed outlines='skirt' to 'head'
    - changed vmin and vmax to vlim tuple 
    - deleted title parameter  
