...
Modified by:
@author_of_modifications: Dawid Jędrzejewski

If any changes, write a brief description here and the author:

- utilities import is different due to environment (Dawid Jędrzejewski)
- n_jobs value is different due to hardware capabilities (Dawid Jędrzejewski)
- in filter_by_class and filter_by_condition, 'Condition' and 'Class' parameters
were changed to 'condition' and 'class_condition' due to changes in Data_processing.py (Dawid Jędrzejewski)
...
from utilities           import Ensure_dir, unify_names
